...
print(f"O sabor escolhido é {pizza_sabor}, o tamanho é {pizza_tamanho} e hoje é {dia_semana}.")
...
if dia_semana == "sábado":
    ...
    print(f"O refri é por conta da casa.")
elif dia_semana == "domingo":
    print(f"🍕 Pedido aceito com sucesso!")
    print(f"O refri e o frete são por conta da casa.")
elif pizza_sabor == "calabresa" and pizza_tamanho == "média":
    print(f"🍕 Pedido aceito com sucesso!")
    print(f"O frete é por conta da casa.")


#Comprando uma pizza de calabresa tamanho médio, em qualquer dia, o frete é grauito.
